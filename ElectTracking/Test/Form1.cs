...
namespace Test
{
    public partial class Form1 : Form
    {
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            switch (tIdx)
            {
                case 1: eTracer1._Draw(@"..\ECIR-S30.DAT", @"..\CIRCULAR-S30.DAT", ETracking.eNumDatum.ZX); break;
                case 2: eTracer1._Draw(@"..\ECIR-CIRCLE.DAT", @"..\CIRCULAR-CIRCLE.DAT", ETracking.eNumDatum.ZX); break;
